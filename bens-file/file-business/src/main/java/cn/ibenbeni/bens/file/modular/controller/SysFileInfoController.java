...
public class SysFileInfoController {
     ...
     * 上传文件
     */
    @PostResource(path = "/sysFileInfo/upload")
     ...
     * 文件下载
     */
    @GetResource(path = "/sysFileInfo/download")
     ...
     */
    @GetResource(path = "/sysFileInfo/getFileInfoListByFileIds")
     ...
     * 根据附件ids查询附件信息
     */
    @PostResource(path = "/sysFileInfo/getFileInfoListByFileIds")
     ...
     * 删除文件（不可逆）
     */
    @PostResource(path = "/sysFileInfo/deleteReally")
     ...
     * 查询文件信息列表（分页）
     */
    @GetResource(path = "/sysFileInfo/page")
     ...
     * 查询详情文件信息
     */
    @GetResource(path = "/sysFileInfo/detail")
