...
public class SysPositionController {
    ...
    @PostResource(path = "/system/position/create")
    ...
    @DeleteResource(path = "/system/position/delete")
    ...
    @PutResource(path = "/system/position/update")
    ...
    @Parameter(name = "id", description = "职位ID", required = true, example = "1")
    @GetResource(path = "/system/position/get")
    ...
    @GetResource(path = "/system/position/simple-list")
    ...
    @GetResource(path = "/system/position/page")
    ...
    @GetResource(path = "/system/position/export-excel")
