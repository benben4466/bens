 ...
 */
public class UserRoleMemoryCache extends AbstractMemoryCacheOperator<List<SysUserRoleDO>> {

    public UserRoleMemoryCache(TimedCache<String, List<SysUserRoleDO>> timedCache) {
        super(timedCache);
    }
