...
public class SysTenantPackageController {
     ...
     * 新增租户套餐
     */
    @PostResource(path = "/tenantPackage/add")
     ...
     * 删除租户套餐
     */
    @PostResource(path = "/tenantPackage/delete")
     ...
     * 删除租户套餐
     */
    @PostResource(path = "/tenantPackage/batchDelete")
     ...
     * 编辑租户套餐
     */
    @PostResource(path = "/tenantPackage/edit")
     ...
     * 根据ID查询租户套餐
     */
    @GetResource(path = "/tenantPackage/detail")
     ...
     * 查询租户套餐列表
     */
    @GetResource(path = "/tenantPackage/list")
     ...
     * 查询租户套餐列表（分页）
     */
    @GetResource(path = "/tenantPackage/page")
